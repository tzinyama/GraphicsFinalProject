...
var stonePlatform = {
  ...
  init: function(x,y,snowy){
    ...
    this.snowy = snowy;
    this.model = this.createStonePlatform(x,y,snowy);
  },
  createStonePlatform: function(x,y,snowy){
...
var snowPlatform = {
  ...
  init: function(w,x,y){
    ...
    this.x = x;
    this.y = y;
    this.model = this.createSnowPlatform(w,x,y);

  },
  createSnowPlatform: function( wid, x, y, seed ){
